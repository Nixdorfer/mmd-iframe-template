export const instancedVS = `#version 300 es
...
export const instancedFS = `#version 300 es
precision highp float;
...
void main() {
	...
	vec3 clr = vClr * texClr.rgb * light * vTint.rgb;
	float alpha = texClr.a * vTint.a;
	if (alpha < 0.1) discard;
	fragColor = vec4(clr, alpha);
}
`

export const INSTANCE_MATRIX_SIZE = 16
export const INSTANCE_TINT_SIZE = 4
export const INSTANCE_DATA_SIZE = INSTANCE_MATRIX_SIZE + INSTANCE_TINT_SIZE
