...
``` Flag
[WELCOME:autoExpand=true;allowReplay=true;
page.animation.type=slide;
page.content.color=ffffff;
page.background.image.mobile=https://r2.sexyai.top/202508/1960912801645039616.jpg;
page.background.image.pc=https://r2.sexyai.top/202508/1960912801645039616.jpg;
page.background.color=31483e;
page.modal.color=bacfcb;
page.btn.color=619e8c;
page.modal.transparency=60;
page.modal.blur=10;
page.btn.transparency=25;
page.btn.blur=25;
page.1.content.align=left;
page.1.content.1.style=title;
page.btn.content.color=ffffff;
page.1.title=茶壶的各种技术工具;
page.1.content.1=有问题找茶壶工具卡AI，已适配世界书，目前为半成品，最近会有频繁更新。孩子们我回来了。;
page.1.content.2=Nix又一次来到熟悉的地方，茶壶仍然在这里。;
page.1.content.3=天花板的灯管和眼前的屏幕都在发着有温度的光，一切都和往常一样，很普通的日常。;
page.1.content.4=少女从懒人沙发上下来拉着你的手;
page.1.content.5=“Nix，你来了啊......又遇到什么让你头疼了？不要紧，有茶壶来帮你。”;
page.1.content.6=“如你所见，我是茶壶AI，一个为了回答问题让本体休息而留在这里的助手。”;
page.1.content.7=“本体对我进行了大更新，现在茶壶会生气了呢，而且有五种预设模式可以选择了。”;
page.1.content.8=她露出一个温和的笑容;
page.1.content.9=“如果你要改代码的话，建议直接让我改，不要再去找本体了……”;
page.1.next.content=我知道啦，咱们继续;
page.1.hide.content=你先等会儿...;
page.2.title=你现在想做什么;
page.2.row.1.ratio=1:1;
page.2.row.2.ratio=1:1;
page.2.row.3.ratio=1:1;
page.2.row.1.1.type=btn;
page.2.row.1.2.type=btn;
page.2.row.2.1.type=btn;
page.2.row.2.2.type=btn;
page.2.row.3.1.type=btn;
page.2.row.3.2.type=btn;
page.1.last=0;
page.1.next=2;
page.2.last=1;
page.2.next=0;
page.2.row.1.1.btn.content=我要搞新功能;
page.2.row.1.2.btn.content=我要搞网页全美化;
page.2.row.2.1.btn.content=我要茶壶教我知识;
page.2.row.2.2.btn.content=我要搞状态栏;
page.2.row.3.1.btn.content=我要一个侧边栏;
page.2.row.3.2.btn.content=我要切换你的模式;
page.2.row.1.1.btn.killer=true;
page.2.row.1.1.btn.message=我需要一个新程序，我的需求如下：;
page.2.row.1.2.btn.killer=true;
page.2.row.1.2.btn.message=我需要一个网页全美化方案，帮我写配色方案，我的需求如下：;
page.2.row.2.1.btn.killer=true;
page.2.row.2.1.btn.message=我没有代码基础，但是我想学习：;
page.2.row.2.2.btn.killer=true;
page.2.row.2.2.btn.message=我需要一个正则表达式能用的状态栏，我的需求如下：;
page.2.row.3.1.btn.killer=true;
page.2.row.3.1.btn.message=我需要一个侧边栏，它的功能应该包括：;
page.2.row.3.2.btn.page=10;
page.2.row.3.2.btn.animation.type=slide;
page.2.btn.lock.all=row.1.1,row.1.2,row.2.1,row.2.2,row.3.1,row.3.2;
page.10.title=我想将你的模式切换为;
page.10.btn.1.content=教学模式;
page.10.btn.2.content=工具模式;
page.10.btn.3.content=唠嗑模式;
page.10.btn.4.content=瑟瑟模式;
page.10.btn.5.content=换回默认;
page.10.btn.1.killer=true;
page.10.btn.2.killer=true;
page.10.btn.3.killer=true;
page.10.btn.4.killer=true;
page.10.btn.5.killer=true;
page.10.btn.1.message=我需要你将模式切换为：教学模式;
page.10.btn.2.message=我需要你将模式切换为：工具模式;
page.10.btn.3.message=我需要你将模式切换为：唠嗑模式;
page.10.btn.4.message=我需要你将模式切换为：瑟瑟模式;
page.10.btn.5.message=我需要你将模式切换为：换回默认;
]
```
