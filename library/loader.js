...
if(L.edit){
fetch(L.base+'library/editor.html?t='+Date.now(),{cache:'no-store'}).then(function(r){return r.text()}).then(function(ed){
document.open();document.write(cfg+h+ed);document.close();
}).catch(function(){document.open();document.write(cfg+h);document.close()});
